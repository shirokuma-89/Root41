...
void _LED::gyroShow(void) {
  ...
  if (LED.white) {
    if (!device.keeper) {
      ...
      RGBLED.setPixelColor(light, 0, 0, 0);
      RGBLED.setPixelColor((light + 1) % 16, 0, 0, 0);
      RGBLED.setPixelColor((light + 15) % 16, 0, 0, 0);
      RGBLED.setPixelColor((light + 2) % 16, 0, 0, 0);
      RGBLED.setPixelColor((light + 14) % 16, 0, 0, 0);
    }
  } else {
    if (ROBOT == 1) {
...
void _LED::lineShow(void) {
  ...
  if (LED.white) {
    if (line.val[0]) {
      ...
      RGBLED.setPixelColor(15, 255, 255, 255);
      RGBLED.setPixelColor(14, 255, 255, 255);
    }
    if (line.val[1]) {
      RGBLED.setPixelColor(10, 255, 255, 255);
      RGBLED.setPixelColor(11, 255, 255, 255);
      RGBLED.setPixelColor(12, 255, 255, 255);
      RGBLED.setPixelColor(13, 255, 255, 255);
      RGBLED.setPixelColor(14, 255, 255, 255);
    }
    if (line.val[2]) {
      RGBLED.setPixelColor(2, 255, 255, 255);
      RGBLED.setPixelColor(3, 255, 255, 255);
      RGBLED.setPixelColor(4, 255, 255, 255);
      RGBLED.setPixelColor(5, 255, 255, 255);
      RGBLED.setPixelColor(6, 255, 255, 255);
    }
    if (line.val[3]) {
      RGBLED.setPixelColor(6, 255, 255, 255);
      RGBLED.setPixelColor(7, 255, 255, 255);
      RGBLED.setPixelColor(8, 255, 255, 255);
      RGBLED.setPixelColor(9, 255, 255, 255);
      RGBLED.setPixelColor(10, 255, 255, 255);
    }
  } else {
    if (line.val[0]) {
...
void _LED::ballShow(int deg) {
  ...
  deg %= 16;
  if (LED.white) {
    RGBLED.setPixelColor(deg, 255, 255, 255);
    RGBLED.setPixelColor((deg + 15) % 16, 255, 255, 255);
    RGBLED.setPixelColor((deg + 1) % 16, 255, 255, 255);
  } else {
